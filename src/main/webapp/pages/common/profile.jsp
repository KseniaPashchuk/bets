                ...
                <div class="user-info colored-block">
                    <form class="user-avatar col-lg-4 col-md-4 col-sm-4"
                        ...
                        <div class="avatar-wrap">
                            <img class="avatar-pic" id="avatar-pic"
                                 src="${pageContext.request.contextPath}/image/user/${user.avatarUrl}"
                    ...
                    <div class="user-meta col-lg-8 col-md-8 col-sm-8 clearfix">
                        ...
                        <div class="value-row col-lg-7">
                            <div class="meta-value">${user.login}</div>
                            <div class="meta-value">${user.firstName}</div>
                            <div class="meta-value">${user.lastName}</div>
                            <div class="meta-value">
                                <fmt:parseDate value="${user.birthDate}" pattern="yyyy-MM-dd" var="parsedDate"
                                               type="date"/>
                            ...
                            <c:if test="${role == 'USER'}">
                                <div class="meta-value">${user.balance}</div>
                                <c:forEach var="item" items="${user.creditCards.creditCardList}">
                        ...
                        <div class="shell-for-input">
                            <label for="edit-name">
                                ...
                                <input class='edit-input <c:if test="${btg:contains(errors,'invalidFirstNameError' )}">error</c:if>'
                                       type="text" id="edit-name" name="name" value="${user.firstName}">
                            </label>
