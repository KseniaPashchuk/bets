...
/**
 * Class provides editing football match operation for bookmaker.
 *
 * @author Pashchuk Ksenia
 * @see AbstractCommand
 */
public class EditMatchCommand implements AbstractCommand {

    private static final String NEXT_PAGE = SHOW_MATCHES_PAGE;
    private MatchReceiver receiver = new MatchReceiverImpl();
    private static final Logger LOGGER = LogManager.getLogger(EditMatchCommand.class);

    /**
     * Provides editing football match operation for bookmaker.
