...
/**
 * Class provides creating confederation operation for admin.
 *
 * @author Pashchuk Ksenia
 * @see AbstractCommand
 */
public class AddConfederationCommand implements AbstractCommand{
    ...
    public PageNavigator execute(RequestContent requestContent) {
        ...
        try {
            receiver.createConfederation(requestContent);
